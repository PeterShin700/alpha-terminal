...
async function test() {
    ...
    const valid = kospi200Options.filter((i: any) => i.itmsNm.includes('380.0'));
    console.log("380 options length:", valid.length);
    console.log("First few 380 options:", valid.slice(0, 5));
}
